<template>
      ...
      <ion-content :fullscreen="true" >
            ...
            <div class="display">
              <div class="shopDisplay" >
                  <ion-img class="store" src="/assets/images/herault.png"  @click="description"></ion-img>
          ...
          <div class="card none">
            <div class="description-card visibility" >
                  ...
                  <h1>Maison Herault</h1>
                  <img class="portrait" src="/assets/images/heraultDescription.png" alt="">
                  
                  <div class="content">
                    
                    <div class="contentDescription">
                      <h2>Boulangerie pâtisserie</h2>
                      <div class="span"></div>
                    </div>
                    <div class="content-fonctionalities">
                        <p class="descriptionText">Maison Lhérault est une enseigne de boulangerie-pâtisserie 
                        artisanale, contemporaine et engagée, dans des produits de 
                        qualité depuis 2014 à Antony.</p>
                        <div class="google">
                          <div class="map">
                            <a target="_blank" href="https://www.google.com/maps/dir/48.8888309,2.2250306/maison+lherault+antony/@48.8191512,2.1059987,11z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x47e6770e95f8ce8d:0x3b7dfd64a99d0a71!2m2!1d2.2971284!2d48.7427739"> <img src="/assets/images/GoogleMap.png" alt=""></a>
                          </div>
                          <p class="mark">4.6</p>
                        </div>
  ...
  return this.items.filter(item =>
    ...
    methods: {
      ...
      store() {
        ...
        if (this.selectedItem.text === this.items.text[0]) {
    ...
    favorite(event) {
      const shopOne = document.querySelector(".shopDisplay .heart:first-of-type")
      const shopTwo = document.querySelector(".shopDisplay .heart:nth-of-type(2)")
      const shopThree = document.querySelector(".shopDisplay .heart:nth-of-type(3)")
      const shopFour = document.querySelector(".shopDisplay .heart:nth-of-type(4)")
  ...
  // addToFavorites() {
  //       // ajouter la boutique aux favoris
